...
class TradeTestCase(TestCase):
    def setUp(self):
        """
        Method that create sample cases in the test database 
        """
        Trade.objects.create(sell_currency='USD', sell_amount=500, buy_currency='EUR', rate=1.2756)
        Trade.objects.create(sell_currency='GBP', sell_amount=1250.50, buy_currency='USD',
                             rate=0.9801)
